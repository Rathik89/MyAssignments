...
public class SalesforceDynamicParameter {
   ...
   driver.findElement(By.xpath("//input[@class='button r4 wide primary']")).click();
     ...
     // String legalentname = driver.findElement(By.xpath("(//lightning-formatted-text[@data-output-element-id='output-field'])[1]")).getText();
      String legalentname = driver.findElement(By.xpath("//div[@class='slds-theme--success slds-notify--toast slds-notify slds-notify--toast forceToastMessage']")).getText();
