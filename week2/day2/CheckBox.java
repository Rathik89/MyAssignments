...
public class CheckBox {
	...
	WebElement message = driver.findElement(By.className("ui-growl-image ui-growl-image-info"));
	String verficationmessage = message.getText();
	
	
	if(verficationmessage.contains("checked") )
	{
	...
	driver.findElement(By.xpath("//div[@class='ui-chkbox-box ui-widget ui-corner-all ui-state-default ui-state-active'][1]")).click();
